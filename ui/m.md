...
```bash
http://event-catalog-service:3001
````
...
```bash
curl http://event-catalog-service:3001/
```
...
```bash
curl http://event-catalog-service:3001/health | jq .
```
...
```bash
curl http://event-catalog-service:3001/events | jq .
```
...
```bash
curl http://event-catalog-service:3001/events/EVENT_ID | jq .
```
...
```bash
curl -X POST http://event-catalog-service:3001/events \
...
```bash
curl -X DELETE http://event-catalog-service:3001/events/EVENT_ID | jq .
```
...
```bash
curl -X POST http://event-catalog-service:3001/events/EVENT_ID/populate \
  -H "Content-Type: application/json" \
  -d '{
    "basePrice": 100,
    "capacity": 10,
...
```bash
curl http://event-catalog-service:3001/events/EVENT_ID/sections | jq .
```
...
```bash
curl http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID | jq .
```
...
```bash
curl -X POST http://event-catalog-service:3001/events/EVENT_ID/sections \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X PUT http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID | jq .
```
...
```bash
curl http://event-catalog-service:3001/events/EVENT_ID/seats | jq .
```
...
```bash
curl http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID/seats | jq .
```
...
```bash
curl http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID/seats/SEAT_ID | jq .
```
...
```bash
curl -X POST http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID/seats \
  -H "Content-Type: application/json" \
  -d '{
    "row": "A",
    "seat_number": 1,
...
```bash
curl -X PUT http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID/seats/SEAT_ID \
  -H "Content-Type: application/json" \
  -d '{
    "status": "reserved"
  }' | jq .
...
```bash
curl -X DELETE http://event-catalog-service:3001/events/EVENT_ID/sections/SECTION_ID/seats/SEAT_ID | jq .
```
